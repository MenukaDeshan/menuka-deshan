...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl }) => {
  return (
    <div className="text-black duration-300 shadow-xl hover:rounded-xl hover:scale-105 hover:shadow-blue-500/95">
      ...
      >
      {/*
        <div className="overlay items-center rounded-xl justify-center absolute top-0 left-0 w-full h-full bg-[#181818] bg-opacity-0 hidden group-hover:flex group-hover:bg-opacity-80 transition-all duration-500 ">
          <Link
            href={gitUrl}
      ...
      <div className="text-white rounded-b-xl mt-3 bg-[#181818] py-6 px-4 mb-3">
